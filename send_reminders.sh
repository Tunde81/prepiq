#!/bin/bash
# PrepIQ — Weekly reminder cron script
...
curl -s -X POST "http://localhost:5010/api/notifications/admin/send-reminders?reminder_type=weekly" \
  -H "Authorization: Bearer $TOKEN" >> /home/ubuntu/prepiq/reminders.log 2>&1

echo "" >> /home/ubuntu/prepiq/reminders.log
echo "$(date): Weekly reminders sent" >> /home/ubuntu/prepiq/reminders.log
